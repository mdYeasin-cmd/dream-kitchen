...
const Blog = () => {
    ...
    return (
        <div className="container my-5">
            ...
            {/* Question - 2 */}
            <h2 className="fs-4 bg-primary text-white px-4 py-2 rounded">Why are you using firebase? What other options do you have to implement authentication?</h2>
            <h3 className="ms-4 mb-3 fs-4">
            ...
            {/* Question - 3 */}
            <h2 className="fs-4 bg-primary text-white px-4 py-2 rounded">dffdf</h2>
            <h3 className="ms-4 mb-3 fs-4">
            ...
            {/* Question - 4 */}
            <h2 className="fs-4 bg-primary text-white px-4 py-2 rounded">What is Node.js? How does Node work?</h2>
            <h3 className="ms-4 mb-3 fs-4">
